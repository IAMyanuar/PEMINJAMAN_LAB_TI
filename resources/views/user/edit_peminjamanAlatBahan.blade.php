...
@section('title')
    SI PIRANG | Form Edit Pengajuan Alat & Bahan
@stop
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Edit Peminjaman Alat Dan Bahan
                    </h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                @endif
                                <div class="card-body">
                                    <form action="{{ route('ubah_pengajuan_alat_bahan', $dataPmj['id']) }}" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kelas"
                                                placeholder="Contoh: 1A-TRPL" value="{{ $dataPmj['kelas'] }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label>PIC-Dosen Pengampu</label>
                                            <input type="text" class="form-control" name="pic"
                                                value="{{ $dataPmj['pic'] }}" required>
                                        </div>
                                        @php
                                            $data_alat_dipinjam = count($dataPmj['peminjamanalat']);
                                            $data_bahan_dipinjam = count($dataPmj['peminjamanbahan']);
                                        @endphp
                                        <div id="alat">
                                            {{-- @if ($data_alat_dipinjam == 0) --}}
                                            ...
                                            {{-- @else
                                                @for ($i = 0; $i < $data_alat_dipinjam; $i++)
                                                    <div class="row alat-row">
                                                        <div class="form-group col-md-7">
                                                            <label>Alat</label>
                                                            <select class="form-control" name="alat[]">
                                                                ...
                                                                @foreach ($alat as $dataAlat)
                                                                    <option value="{{ $dataAlat['id'] }}"
                                                                        {{ $dataPmj['peminjamanalat'][$i]['id_alat'] == $dataAlat['id'] ? 'selected' : '' }}>
                                                                        {{ $dataAlat['nama'] }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <label>Jumlah</label>
                                                            <input type="number" class="form-control" name="jumlah_alat[]"
                                                                value="{{ $dataPmj['peminjamanalat'][$i]['jumlah'] }}">
                                                        </div>
                                                        <div class="p-4">
                                                            @if ($i == 0)
                                                                <button type="button" class="btn btn-circle btn-primary"
                                        ...
                                        <div id="bahan">
                                            ...
                                            {{-- @else
                                                @for ($i = 0; $i < $data_bahan_dipinjam; $i++)
                                                    <div class="row bahan-row">
                                                        <div class="form-group col-md-7">
                                                            <label>Bahan</label>
                                                            <select class="form-control" name="bahan[]">
                                                                ...
                                                                @foreach ($bahan as $dataBahan)
                                                                    <option value="{{ $dataBahan['id'] }}"
                                                                        {{ $dataPmj['peminjamanbahan'][$i]['id_bahan'] == $dataBahan['id'] ? 'selected' : '' }}>
                                                                        {{ $dataBahan['nama'] }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <label>Jumlah</label>
                                                            <input type="number" class="form-control" name="jumlah_bahan[]"
                                                                value="{{ $dataPmj['peminjamanbahan'][$i]['jumlah'] }}">
                                                        </div>
                                                        <div class="p-4">
                                                            @if ($i == 0)
                                                                <button type="button" class="btn btn-circle btn-primary"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" name="tgl_pinjam"
                                                value="{{ $dataPmj['tgl_pinjam'] }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Waktu Selesai</label>
                                            <input type="datetime-local" class="form-control" name="tgl_selesai"
                                                value="{{ $dataPmj['tgl_selesai'] }}" required>
                                        </div>
