    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ url('/PengajuanAlatDanBahan') }}"aria-expanded="false"><i class="far fa-paper-plane"></i><span class="hide-menu">Pengajuan Alat dan Bahan</span></a></li>
