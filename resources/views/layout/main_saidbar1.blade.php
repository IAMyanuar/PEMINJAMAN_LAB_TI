    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href={{ url('/admin/konfirmasiuserbaru') }} aria-expanded="false"><i data-feather="user" class="feather-icon"></i><span class="hide-menu">Konfirmasi User Baru</span>
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href={{ url('/admin/accpeminjaman') }} aria-expanded="false"><i class="icon-check"></i><span class="hide-menu">Konfirmasi Peminjaman</span></a></li>
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href={{ url('/admin/DataAlat') }} aria-expanded="false"><i class="fas fa-box-open"></i><span class="hide-menu">Data Alat</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href={{ url('/admin/DataBahan') }} aria-expanded="false"><i class="fas fa-box-open"></i><span class="hide-menu">Data Bahan</span></a></li>
