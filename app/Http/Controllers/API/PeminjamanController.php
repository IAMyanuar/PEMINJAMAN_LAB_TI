    ...
    public function index()
    {
        ...
        $datapeminjaman = Peminjaman::join('users', 'peminjamen.user_id', '=', 'users.id')
            ...
            ->select(
                ...
                Peminjaman::raw("TIME_FORMAT(peminjamen.tgl_mulai, '%H:%i:%s') as jam_mulai"), // Format waktu untuk MySQL
                Peminjaman::raw('DATE(peminjamen.tgl_selesai) as tgl_selesai'), // Mengambil tanggal saja
                Peminjaman::raw("TIME_FORMAT(peminjamen.tgl_selesai, '%H:%i:%s') as jam_selesai"), // Format waktu untuk MySQL
                'peminjamen.status',
                'peminjamen.feedback',
