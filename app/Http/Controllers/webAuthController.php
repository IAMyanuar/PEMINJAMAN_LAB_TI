...
class webAuthController extends Controller
{
    ...
    public function Login(Request $request)
    {
        try {
            ...
            if ($contenarray['status_user'] == "terkonfirmasi" && $contenarray['role'] == "peminjam") {
            ...
            if ($contenarray['status_user'] == "terkonfirmasi" && $contenarray['role'] == "admin") {
                $token = $contenarray['token'];
                $id_user = $contenarray['id_user'];
                $nama = $contenarray['nama'];
                session(['nama' => $nama]);
          	...
          	if($contenarray['status_user'] == "belum_dikonfirmasi"){
              return redirect()->back()->withErrors(['error' => 'akun anda belum di konfirmasi silahkan hubungi pihak terkait']);
            }
          
          	if($contenarray['status_user'] == "tidak_dikonfirmasi"){
              return redirect()->back()->withErrors(['error' => 'akun anda tidak di konfirmasi silahkan hubungi pihak terkait untuk mendaftar ulang']);
            }
